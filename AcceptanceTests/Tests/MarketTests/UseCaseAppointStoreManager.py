...
class UseCaseAppointStoreManager(unittest.TestCase):
    ...
    def test_AppointStoreManagerNoStore(self):
        self.assertTrue(self.proxy_market.appoint_store_manager(-1, self.owner_id,  "testUser2").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(-2, self.owner_id,  "testUser2").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(-3, self.owner_id,  "testUser2").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(-4, self.owner_id,  "testUser2").isError())
    ...
    def test_AppointStoreManagerNoNewManager(self):
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.owner_id, "noUser1").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.owner_id, "").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.owner_id, "2543").isError())
    ...
    def test_AppointStoreManagerTwice(self):
        ...
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.owner_id,  "testUser2").isError())
        self.proxy_user.logout_member(self.owner_id)
        self.proxy_user.login_member(self.owner_id, "testUser", "1234")
        self.proxy_market.appoint_store_manager(self.store_id, self.owner_id, "testUser3")
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.owner_id, "testUser3").isError())

    def test_AppointStoreManagerNoPermission(self):
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.manager_id1, "testUser2").isError())
        self.proxy_user.logout_member(self.manager_id1)
        self.proxy_user.login_member(self.manager_id1, "testUser2", "4321")
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.manager_id1, "testUser3").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.manager_id1, "testUser4").isError())
        self.assertTrue(self.proxy_market.appoint_store_manager(self.store_id, self.manager_id1, "").isError())
