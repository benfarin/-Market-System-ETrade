...
class UseCaseAppointStoreOwner(unittest.TestCase):
    ...
    def test_AppointStoreOwnerPositive(self):
        ...
        self.assertEqual(self.proxy_market.appoint_store_owner(self.store_id, self.owner_id, "testUser2").getData(),True)
        self.proxy_user.logout_member(self.owner_id)
        self.proxy_user.login_member("testUser", "1234")
        self.assertEqual(self.proxy_market.appoint_store_owner(self.store_id, self.owner_id, "testUser3").getData(),True)
