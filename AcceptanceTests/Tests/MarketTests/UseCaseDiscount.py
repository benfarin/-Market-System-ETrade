...
class UseCaseDiscount(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.proxy_user.register(cls.__guestId1, "testUser1", "1234", "0540000000", 123, [], "Israel", "Beer Sheva",
                                "Rager", 1,
                                "testBank")
