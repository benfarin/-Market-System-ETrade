...
class UseCaseGetStoresInfo(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.store_id1 = cls.proxy_user.open_store("testStore1", cls.owner_id, 123, None, "Israel", "Beer Sheva", "Rager", 1, 00000).getData().getStoreId()
        ...
        cls.proxy_market.appoint_store_manager(cls.store_id, cls.owner_id, "testUser2")

    def test_get_stores_info_positive(self):
        permissions = self.proxy_market.get_store_info(self.store_id, self.owner_id).getData()
    ...
    def test_user_store(self):
        userStores = self.proxy_market.getUserStore(self.owner_id).getData()
