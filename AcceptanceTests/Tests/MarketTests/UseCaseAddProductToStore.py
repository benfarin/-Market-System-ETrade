...
class UseCaseAddProduct(unittest.TestCase):
    ...
    def test_addProductPositive(self):
        p1_id = self.proxy_market.add_product_to_store(self.store_id1, self.user_id1, "testProduct1", 10, "testCategory", 15,
                                               ["test"]).getData().getProductId()
        p2_id = self.proxy_market.add_product_to_store(self.store_id1, self.user_id1, "testProduct2", 100, "testCategory", 10,
                                               ["test"]).getData().getProductId()
