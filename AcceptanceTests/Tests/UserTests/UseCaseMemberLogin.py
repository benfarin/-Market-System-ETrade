...
class UseCaseMemberLogin(unittest.TestCase):
    ...
    def test_two_member_log_in_together(self):
        ...
        self.proxy.register(self.__guestId4, "user4", "1234", "0500000000", 500, 20, "Israel", "Beer Sheva",
                            "Ben Gurion", 0, 1)
        self.__guestId5 = self.proxy.login_guest().getData().getUserID()
        self.proxy.register(self.__guestId5, "user5", "1234", "0500000000", 500, 20, "Israel", "Beer Sheva",
                            "Ben Gurion", 0, 1)
        self.__guestId6 = self.proxy.login_guest().getData().getUserID()
        self.proxy.register(self.__guestId6, "user6", "1234", "0500000000", 500, 20, "Israel", "Beer Sheva",
                            "Ben Gurion", 0, 1)
        self.__guestId7 = self.proxy.login_guest().getData().getUserID()
        self.proxy.register(self.__guestId7, "user7", "1234", "0500000000", 500, 20, "Israel", "Beer Sheva",
                            "Ben Gurion", 0, 1)
        ...
        t4 = ThreadWithReturn(target=self.proxy.login_member, args=("user4", "1234"))
        t5 = ThreadWithReturn(target=self.proxy.login_member, args=("user5", "1234"))
        t6 = ThreadWithReturn(target=self.proxy.login_member, args=("user6", "1234"))
        t7 = ThreadWithReturn(target=self.proxy.login_member, args=("user7", "1234"))
