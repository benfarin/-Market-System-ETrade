...
class MyTestCase(unittest.TestCase):
    ...
    def test_all(self):
        self.bag.addProduct(self.p1.getModel(), 2)
        self.bag.addProduct(self.p1.getModel(), 1)
        self.bag.addProduct(self.p2.getModel(), 3)

        self.assertEqual(450, self.bag.calcSum(None))
        self.assertEqual(3, self.bag.removeProduct(self.p1.getProductId()))

        self.bag.updateBag(self.p2.getProductId(), 2)
        self.assertEqual(500.0, self.bag.calcSum(None))

        self.bag.updateBag(self.p2.getProductId(), -2)
        self.assertEqual(300.0, self.bag.calcSum(None))
